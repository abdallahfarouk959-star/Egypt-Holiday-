        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              type: "Luxury Nile Egypt",
              price: "$1339",
              img: "https://i.ibb.co/JWHjLNph/2826704021752749842.jpg",
              link: "/nile-cruise/luxor-aswan-cruise/1",
            },
            {
              ...
              type: "Dahabiya Nile",
              price: "$1179",
              img: "https://i.ibb.co/My9R1frG/Swan-Drone-2-scaled.webp",
            ...
            },
            {
              ...
              price: "$479",
              img: "https://i.ibb.co/Cp7m24WM/800x600-exterior-close-1.webp",
              link: "/nile-cruise/luxor-aswan-cruise/1",
            },
          ].map((cruise, i) => (
            <motion.div
        ...
        <div className="bg-white border border-gray-100 rounded-[2rem] p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 shadow-xl hover:shadow-2xl transition-all duration-500 relative overflow-hidden group">
          ...
          <div className="flex-1 text-center md:text-left z-10">
            <div className="flex items-center justify-center md:justify-start gap-1 mb-3">
              ...
              <span className="ml-3 text-sm font-bold text-gray-800 uppercase tracking-widest">
                Excellent
              </span>
            </div>
            ...
            <p className="text-gray-500 text-sm md:text-base leading-relaxed">
              Every Journey We Create Is Designed With Care And Delivered By
              People Who Truly Know Egypt . See What Our Guests Say About
              Traveling With Us
            </p>
          </div>
