        ...
        <div className="bg-white border border-emerald-100 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6 shadow-sm">
          <div className="w-20 h-20 bg-emerald-50 rounded-xl flex items-center justify-center">
            ...
            >
              ...
              <path
                d="M7 9.5C7.55228 9.5 8 9.05228 8 8.5C8 7.94772 7.55228 7.5 7 7.5C6.44772 7.5 6 7.94772 6 8.5C6 9.05228 6.44772 9.5 7 9.5Z"
                fill="#000"
              />
              <path
              ...
              />
              <path
                d="M16.5 9.5C17.0523 9.5 17.5 9.05228 17.5 8.5C17.5 7.94772 17.0523 7.5 16.5 7.5C15.9477 7.5 15.5 7.94772 15.5 8.5C15.5 9.05228 15.9477 9.5 16.5 9.5Z"
                fill="#000"
              />
            </svg>
          </div>
          ...
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-xl font-bold text-gray-900">
              Egypt Holiday — TripAdvisor
            </h3>
            <p className="text-sm text-gray-500 mt-1">
              See our official TripAdvisor listing and recent reviews.
            </p>
          </div>
